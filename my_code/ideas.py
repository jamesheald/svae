# check samples from prior of fitted model
...
# non-EM version where you don't incorporate prior into q and do message passing (just model q directly e.g. with BiGRU)
