...
def main():
    ...
    parser.add_argument('--save_dir',                    default = '/nfs/nhome/live/jheald/svae/runs/NoDeltaQ_NoDeltaF_NoDeltaFNP_NoFTimeDepend_NoAnsatz_MyInference_svae_seed3')
    ...
    parser.add_argument('--learn_policy',                type = lambda x: bool(strtobool(x)), default = '1')
    ...
    parser.add_argument('--train_size',                  type = int, default = 10) # 800
    parser.add_argument('--val_size',                    type = int, default = 10) # 200
    ...
    parser.add_argument('--prior_base_lr',               type = float, default = 1e-3)
